...
class Server:
    def __init__(self):
        ...
        self.server.bind(("0.0.0.0",SERVER[1]))
...
#==============================================================================
                ...
                if len(the_guys) == 2:
                    ...
                    if g != from_name:
                        ...
                        mysend(from_sock, json.dumps({"action": "game", "status": "success"}))
                else:
                    mysend(from_sock, json.dumps({"action": "game", "status": "user-num-error",
                                                  "description": "You can only play with one person,not " + str(
                                                      len(the_guys) - 1)}))
                ...
                if len(the_guys) == 2:
                    ...
                    if g != from_name:
                        to_sock = self.logged_name2sock[g]
                        mysend(to_sock, json.dumps({"action": "gaming", "choice": msg["choice"]}))
#==============================================================================
